...
export function FrontPageWorkSection({ allWorkPages }) {
  return (
    <div>
      ...
      <div className="mb-12">
        {allWorkPages.slice(0, 1).map((workPage: PageType, index) => (
          <div key={index}>
            <div
              key={workPage.id}
              className="flex justify-center items-center p-12 bg-primary-50 h-[450px] rounded-lg"
            >
      ...
      <div className=" w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3  mb-12 gap-6">
        {allWorkPages.slice(1, 4).map((workPage: PageType, index) => (
          <div key={index}>
            <div key={workPage.id}>
              {workPage.field_content_elements &&
                workPage.field_content_elements
