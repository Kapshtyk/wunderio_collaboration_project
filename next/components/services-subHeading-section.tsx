          ...
          {tags
            ...
            .map((tag) => (
              <>
                <div
                  key={tag.id}
                  className="flex flex-col w-[1440px] gap-[10px] pl-[112px] pr-[80px] pt-[40px] pb-[10px] relative"
                >
                  <div className="gap-[24px] inline-flex flex-col items-start relative flex-[0_0_auto]">
                    ...
                    {services
                      ...
                      .map((service) => (
                        <div
                          key={service.id}
                          className="gap-[8px] inline-flex flex-col items-start relative flex-[0_0_auto]"
                        >
                          <Link
                            key={service.id}
